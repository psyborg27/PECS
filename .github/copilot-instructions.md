...
After significant Copilot interactions, append an event:
...
- Do NOT delete or edit `.pecs` files directly.
- PECS is a locality projection layer, not editable sourcecode.
- For the canonical PECS consumer workflow, see `.pecs/PECS_CONSUMER_PROTOCOL.md`.
