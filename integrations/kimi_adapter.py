...
class KimiAdapter:
    """
    Canonical Kimi integration adapter for PECS Core v1.

    Kimi consumes PECS context exclusively through the PECS-LITE compatibility layer.
    """
    ...
    def build_kimi_context(
        ...
        emit_runtime_event(
            subsystem="DOWNSTREAM",
            event="kimi_projection_finalized",
            payload={
                "query": query,
